...
class QuizDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.iquiz_quiz.collection');
  }
  ...
  public function getDescription() {
    return $this->t('This action cannot be undone and will also delete all the question instances and answers associated with this quiz.');
  }
